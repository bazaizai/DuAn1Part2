...
namespace _3.PL.Views
{
    public partial class FrmKichCo : Form
    {
        ...
        public void LoadData()
        {
            ...
            {
                dtg_Show.Rows.Add(item.Id, item.Ma, item.Size,item.Cm,item.Inch, item.TrangThai == 0 ? "Hoạt động" : "Không hoạt động");
            }
        }
            ...
            else
            {
                ...
                if (dg == DialogResult.Yes)
                {
                    KichCoViews a = new KichCoViews()
                    {
                        ...
                        Inch=Convert.ToDecimal(tb_Inch.Text),
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dg == DialogResult.Yes) { 
                        ...
                        _KichCo.Inch = Convert.ToDecimal(tb_Inch.Text);
