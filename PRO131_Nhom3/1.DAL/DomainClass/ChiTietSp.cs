...
namespace _1.DAL.DomainClass
{
    ...
    public partial class ChiTietSp
    {
        ...
        public ChiTietSp(Guid id, Guid? idSp, Guid? idMauSac, Guid? idKichCo, Guid? idTeam, Guid? idChatLieu, string baoHanh, string moTa, int? soLuongTon, decimal? giaNhap, decimal? giaBan, int? trangThaiKhuyenMai, int? trangThai)
        {
            Id = id;
            IdSp = idSp;
            IdMauSac = idMauSac;
