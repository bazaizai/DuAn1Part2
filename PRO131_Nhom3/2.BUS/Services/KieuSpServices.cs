...
namespace _2.BUS.Services
{
    public class KieuSpServices : IKieuSpServices
    {
        ...
        public string Add(KieuSpView Obj)=> Obj != null && GetAll().All(x => x.Ten != Obj.Ten) && _IKieuSpRespos.Add(new KieuSp(Obj.Ma, Obj.Ten, Obj.TrangThai)) ? "Add success" : "Add not success";
